...
const ClientReviews = () => {
  return (
    <section className="bg-[#F2F4F7] py-20 px-4 font-sans overflow-hidden">
      <div className="max-w-7xl mx-auto text-center mb-16">
        {/* Top Illustration placeholder (Reference: image_87d020.png style) */}
        <div className="flex justify-center mb-6">
           <div className="w-48 h-24 border border-dashed border-teal-600/30 rounded-lg flex items-center justify-center text-teal-600 text-[10px]">
             [Insert Logistics Illustration here]
           </div>
        </div>
        ...
        <p className="text-[#5F7180] max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
      ...
      <div className="relative">
            ...
            <SwiperSlide key={item.id}>
              {({ isActive }) => (
                <div className={`
                  ...
                  ${isActive ? 'scale-105 shadow-xl opacity-100' : 'scale-90 opacity-40 grayscale'}
                `}>
                  {/* Quote Icon */}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <h4 className="text-[#02312A] font-extrabold text-lg">{item.name}</h4>
        ...
        <div className="flex flex-col items-center gap-6 mt-4">
          <div className="flex items-center gap-4">
            {/* Prev Button */}
            <button className="nav-prev btn btn-circle btn-ghost border border-gray-300 hover:bg-white text-xl shadow-sm">
              <LuMoveLeft />
            </button>
