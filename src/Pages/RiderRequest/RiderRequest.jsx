              ...
              >
                ...
                <td className="px-8 py-5">
                  <div className="flex justify-end gap-3">
                    <button className="p-2.5 text-blue-500 hover:bg-blue-50 rounded-xl transition-colors border border-transparent hover:border-blue-100">
                      <RiEyeLine size={18} />
                    </button>
                    <button
